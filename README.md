...
| Tool | Version | Notes |
|------|---------|-------|
| AMRFinderPlus | 4.2.7 | latest |
| ECTyper | 2.0.0 | latest |
| MacSyFinder (TXSScan) | 2.1.6 | latest |
| MLST | 2.25.0 | pinned |
| CheckM2 | ≥1.1.0 | Minimum version |
